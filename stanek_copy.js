...
const argsSchema = [
    ['reserved-ram', 76], // Don't use this RAM
    ['reserved-ram-ideal', 152], // Leave this amount of RAM free if it represents less than 5% of available RAM
    ['max-charges', Infinity], // Stop charging when all fragments have this many charges (diminishing returns - num charges is ^0.07 )
